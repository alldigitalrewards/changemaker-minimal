...
import { dismissNotification } from '@/lib/db/notifications'
import {
  getWorkspaceBySlug,
  getUserBySupabaseId,
...
export async function POST(
  ...
  try {
    ...
    // Dismiss notification (includes ownership check in function)
    const notification = await dismissNotification(notificationId, dbUser.id)
