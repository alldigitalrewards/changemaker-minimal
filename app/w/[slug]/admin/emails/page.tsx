...
function DefaultEmailsPanel({ slug, workspaceName, userEmail }: { slug: string; workspaceName: string; userEmail: string }) {
...
function TemplatesPanel({ slug }: { slug: string }) {
...
function EmailSettingsPanel({ slug }: { slug: string }) {
  const [loading, setLoading] = useState(true)
