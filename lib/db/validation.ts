...
export function validateSchemaStructure() {
  // Skip validation during build when DATABASE_URL might not be available
...
export class WorkspaceQueryValidator {
  private static workspaceScoped = ["user", "challenge", "enrollment"];
...
export function auditQueryIsolation() {
  ...
  const expectedPatterns = {
    ...
    "enrollment queries":
      "Must filter by { challenge: { workspaceId } } or join through user/challenge",
